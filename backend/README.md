...
## Project Structure
    ...
    ├── tstdanielblank_dev_22855  # Django project configurations
...
1. Clone this repo and `cd tstdanielblank_dev_22855`
...
2. Clone this repo and `cd tstdanielblank_dev_22855`
